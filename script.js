...
// setting audio for alarm, when it is about to ring
...
const alarmList = [];  // This array will store all the upcoming alarms



// function for palying the audio when alarm time will come
function ringing(now){
    audio.play();
    alert(`Hey! it is ${now}`)//while playing audio, we will also get an alert on window
}


// This fuction will update our digital clock every second
function updateTime() {
    var today = new Date();
